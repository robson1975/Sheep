...
import com.example.hugov.appcurso.adaptador.CursosAdapterImg;
 ...
 */
public class consultarListaCursoImagem extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_consultar_lista_curso_imagem, container, false);

        listaCursos=new ArrayList<>();

        recyclerCursos= (RecyclerView) vista.findViewById(R.id.idRecyclerImagem);
    ...
    private void carregarWEBService() {
        ...
        String url = "http://192.168.1.4/webservices/consultarListaImagem.php";
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            ...
            progresso.hide();
            CursosAdapterImg adapter = new CursosAdapterImg(listaCursos);
